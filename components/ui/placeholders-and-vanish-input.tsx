  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-35 border-none dark:text-white bg-transparent text-black h-full rounded-xl focus:outline-none focus:ring-0 pl-4 sm:pl-5 pr-16",
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="dark:text-zinc-500 z-10 text-sm sm:text-base font-normal text-neutral-500 pl-4 sm:pl-6 text-left w-[calc(100%-2rem)] truncate"
            >
